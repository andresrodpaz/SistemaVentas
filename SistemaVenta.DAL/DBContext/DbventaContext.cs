...
/// <summary>
/// Contexto de la base de datos que representa las entidades del sistema de ventas.
/// </summary>
public partial class DbventaContext : DbContext
{
    ...
    // Método de configuración del modelo al crear el contexto
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        // Configuración detallada de cada entidad
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C29464CD9");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F4ED24E13");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483E25D93F4");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107A04A9DA8");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EBBEF6386");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13298F1CE8A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76523DCEC3");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D833DB43EB");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE6AC03BFB");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6CA394D97");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561483FAFE1D");
